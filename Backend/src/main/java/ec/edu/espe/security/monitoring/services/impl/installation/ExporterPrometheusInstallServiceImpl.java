...
import ec.edu.espe.security.monitoring.dto.request.PrometheusExporterRequestDto;
...
@Slf4j
@AllArgsConstructor
public class PrometheusExporterServiceImpl implements PrometheusExporterService {

    private final InstallationConfigRepository installationConfigRepository;
    private final SystemParametersRepository systemParametersRepository;

    @Override
    public void saveOrUpdatePrometheusExporters(PrometheusExporterRequestDto requestDto) {
